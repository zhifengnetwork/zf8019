...
use QrCode\src\Exception\InvalidPathException;
use QrCode\src\Exception\InvalidWriterException;
use QrCode\src\Exception\UnsupportedExtensionException;
use QrCode\src\Writer\WriterInterface;
